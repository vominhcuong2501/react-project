...
import appStyle from '@scss/pages/insight-type/index.scss';
...
export default function InsightsDetailType({ detailPage, noData }: any) {
  ...
  const handlePageChange = async (page, param) => {
    ...
    setTotalPage(get(response, 'total', 1));
  ...
  return (
    <>
      ...
      <div className="ibc-insight__detail" ref={insightsRef}>
        ...
        <div className="ibc-container">
          <div className="ibc-container-content ibc-container-content__pagination">
            {totalPage > PER_PAGE && (
              <Pagination
